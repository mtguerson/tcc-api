...
var GetExpenseByIdUseCase = /** @class */ (function () {
    function GetExpenseByIdUseCase() {
    }
    GetExpenseByIdUseCase.prototype.execute = function (_a) {
        return __awaiter(this, arguments, void 0, function (_b) {
            var expense;
            var id = _b.id;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0: return [4 /*yield*/, client_1.prisma.expense.findMany({
                            where: {
                                id: id,
                            },
                        })];
