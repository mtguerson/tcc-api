...
class ChatBot {
  ...
  start() {
    return __awaiter(this, void 0, void 0, function* () {
      this.telegramSender.on('message', (message) =>
  ...
  startFinancesBot(_, chatId) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      this.groqContext = {
        chatHistory: (0, finances_bot_prompt_1.financesBotPrompt)({
          categories,
          checkingAccounts,
        }),
  ...
  quitSession(chatId) {
    return __awaiter(this, void 0, void 0, function* () {
      const quitMessage =
        'Sessão encerrada. Obrigado por usar o bot de finanças.'
    ...
    return __awaiter(this, void 0, void 0, function* () {
      try {
        const successMessage =
          'Transação criada com sucesso. Obrigado por usar o bot de finanças.'
  ...
  handleGroqCallFunction(toolCall, chatId) {
    return __awaiter(this, void 0, void 0, function* () {
      const noRepeatsCalls = Array.from(
        new Map(toolCall.map((tool) => [tool.function.name, tool])).values(),
      )
  ...
  handleMessages(message) {
    return __awaiter(this, void 0, void 0, function* () {
      let _a, _b, _c
      if (
        ((_a = message.chat) === null || _a === void 0
          ? void 0
          : _a.username) !== this.USERNAME
      )
        return
      ...
      if (
        ((_b = message.text) === null || _b === void 0
          ? void 0
          : _b.toLocaleLowerCase()) === 'sair'
      ) {
        this.quitSession(chatId)
        return
      }
      ...
      this.groqContext.chatHistory.push({
        role: 'user',
        content:
          messageContent !== null && messageContent !== void 0
            ? messageContent
            : '',
        name: userFirstName,
      })
      ...
      const response =
        (_c = groqMessage.content) !== null && _c !== void 0 ? _c : ''
  ...
  getResponseGroqResponse() {
    return __awaiter(this, void 0, void 0, function* () {
      const params = {
        ...
        tools:
          this.groqContext.tools.length > 0
            ? this.groqContext.tools
            : undefined,
        model:
          this.groqContext.tools.length > 0
      ...
      const chatCompletion =
        yield this.GroqSender.chat.completions.create(params)
